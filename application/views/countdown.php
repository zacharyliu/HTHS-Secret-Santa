...
<head>
	...
	<script language="Javascript" type="text/javascript" src="<?php echo base_url('js/jquery.lwtCountdown-1.0.js');?>"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo ($theme == 'light') ? base_url('css/timer/light.css') : base_url('css/timer/dark.css');?>"></link>
</head>
