...
<form>
<?php if (isset($success_code) && $success_code == true) echo '<div style="color:green;margin:10px 0 10px 0;font-size:12px;text-indent:5px">You have successfully joined the group <b>'.$this->datamod->getGroupName(set_value('group')).'</b>!</div>';?>
